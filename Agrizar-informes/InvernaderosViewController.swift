...
class InvernaderosViewController: UIViewController {
    ...
    var endDate = Date()
    var fechaMenosTresMeses = Date()
    var fechaMenosTresMesesFormateada = ""
    ...
    override func viewDidLoad() {
        ...
        fechaMenosTresMeses = Date(timeInterval: -2592000, since: self.startDate)
        
        fechaMenosTresMesesFormateada = df.string(from: fechaMenosTresMeses)
        ...
        print("Fecha -3 meses: ", fechaMenosTresMesesFormateada)
        //2592000 segundos tiene un mes(30 días) 7776000 son 90 días
//        df.dateFormat = "dd-MM-yyyy HH:mm:ss"
        //El día tiene 86400 segundos, se usa para avanzar o retroceder en el tiempo
        
        print("Fecha fin: ",dateString2)
        //let formatter = DateComponentsFormatter()
        //formatter.allowedUnits = [.weekOfYear]
        //let semanas = formatter.string(from: endDate, to: startDate)
        
        //print("Semanas pasadas: ", semanas ?? 0)
        ...
        if(frutoid==1){
            ...
            print("cadenaUrlGenerica del if: ",cadenaUrlGenerica)
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "campari")
        }else if(frutoid==3){
            cadenaUrlGenerica = cadenaUrlPhpEsparrago
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "esparrago")
        }else if(frutoid==4){
            ...
            cadenaUrlGenerica = cadenaUrlPhpKaboom
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "kaboom")
        }else if(frutoid==8){
            ...
            cadenaUrlGenerica = cadenaUrlPhpRedSeedless
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "red seedless osp")
        }else if(frutoid==10){
            ...
            cadenaUrlGenerica = cadenaUrlPhpArandano
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "arandano")
        }else if(frutoid==13){
            cadenaUrlGenerica = cadenaUrlPhpFrambuesa
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "frambuesa")
        }else if(frutoid==14){
            cadenaUrlGenerica = cadenaUrlPhpZarzamora
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "zarzamora")
        }else if(frutoid==15){
            cadenaUrlGenerica = cadenaUrlPhpFresa
            dibujarInvernaderos()
            dropDown.layer.opacity = 0
            colorPimiento.image = UIImage(imageLiteralResourceName: "fresa")
        }
    ...
    @IBAction func btnInvernadero(_ sender: UIButton) {
        ...
        print(sender.tag)
        if(sender.tag==1000){
            //cadena = cadenaUrlGenerica + cadenaFruto + String(frutoid) + cadenaColor + String(self.idColorPimiento) + cadenaInvernadero + "A" + "&fechaInicio=15-04-2022&fechaFin=15-06-2022"
            ...
            //cadena = cadenaUrlGenerica + cadenaFruto + String(frutoid) + cadenaColor + String(self.idColorPimiento) + cadenaInvernadero + "B" + "&fechaInicio=15-04-2022&fechaFin=15-06-2022"
            ...
            //cadena = cadenaUrlGenerica + cadenaFruto + String(frutoid) + cadenaColor + String(self.idColorPimiento) + cadenaInvernadero + "E" + "&fechaInicio=15-04-2022&fechaFin=15-06-2022"
...
//        }
        // Generación de los invernaderos de acuerdo al color del pimiento
